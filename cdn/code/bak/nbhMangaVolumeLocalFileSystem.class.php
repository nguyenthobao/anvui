 ...
 **/
class nbhMangaVolumeLocalFileSystem extends nbhMangaVolumeDriver {
	...
	protected function _extract($path, $arc) {
		...
		if ($this->quarantine) {
			...
			if ($symlinks) {
				return $this->setError(nbhManga::ERROR_ARC_SYMLINKS);
			}

			// check max files size
			if ($this->options['maxArcFilesSize'] > 0 && $this->options['maxArcFilesSize'] < $this->archiveSize) {
				return $this->setError(nbhManga::ERROR_ARC_MAXSIZE);
			}
