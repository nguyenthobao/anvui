...
include_once dirname(__FILE__).DIRECTORY_SEPARATOR.'nbhMangaConnector.class.php';
include_once dirname(__FILE__).DIRECTORY_SEPARATOR.'nbhManga.class.php';
include_once dirname(__FILE__).DIRECTORY_SEPARATOR.'nbhMangaVolumeDriver.class.php';
include_once dirname(__FILE__).DIRECTORY_SEPARATOR.'nbhMangaVolumeLocalFileSystem.class.php';
...
$logger = new elFinderSimpleLogger('logs/temp/log.txt');
...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'       => '../media/'.$idw,
			//'startPath'  => '../../media/1/',
			'URL'        => dirname($_SERVER['PHP_SELF']) . '/../media/'.$idw,
			// 'treeDeep'   => 3,
			// 'alias'      => 'File system',
			'mimeDetect' => 'internal',
			'tmbPath'    => '.tmb',
...
$connector = new nbhMangaConnector(new nbhManga($opts), true);
$connector->run();
