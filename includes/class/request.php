...
class Request
{
     ...
     * @return
     */
    private function get_value ( $name, $mode = null, $default = null, $decode = true,$debug=null )
    {
     ...
     * @return
     */
    public function get_int ( $name, $mode = null, $default = null, $decode = true,$debug="kien" )
    {
        return ( int )$this->get_value( $name, $mode, $default, $decode,'kien' );
    }
