...
class BncUpload {
	...
	public function __construct($options = null) {
		...
		$this->options = array(
			'sv_url'            => 'http://anvui.vn/cdn/index.php?data=',
			'sv_url_del'        => 'http://anvui.vn/cdn/qc.php', 
			'thumb'             => array('100'),
		...
		$this->adminUrl       = 'http://anvui.vn/admin'; 
	...
	public function upload($idw = 1, $module = null, $name_field = null, $name_up = '', $thumb = null) {
		...
		$cfile = new CURLFile($this->options['tmp_upload'] . '/' . $name_file,'image/jpeg',$name_file);
		$postData = array(
			'file' => $cfile,
		);  
		curl_setopt($ch, CURLOPT_POSTFIELDS, $postData);
