 ...
 * @File /data/www/superweb/anvui/tmp/tpl/admin_tuyen_ben.php 
                                ...
                                <div class="list-car"> 
                                    <div class="list-car-body">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php if(is_array($data['ben'])) { foreach($data['ben'] as $k => $v) { ?>
                                                <tr>
                                                    <td><?=$v['pointName']?></td>
                                                    <td><?=$v['address']?></td>  
                                                    <!-- <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a href="/suaben?id=<?=$v['pointId']?>">Sửa</a></li>
                                                                <li><a href="javascript:;" clas="xoa" data-id="<?=$v['pointId']?>">Xoá</a></li> 
                                                            </ul>
                                                        </div>
