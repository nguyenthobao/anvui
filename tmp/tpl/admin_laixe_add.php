 ...
 * @File /data/www/superweb/anvui/tmp/tpl/admin_laixe_add.php 
                                 ...
                                 <form action="" method="POST">
                                  ...
                                  <div class="form-group f1">
                                    ...
                                    <select class="form-control" name="userType" id="userType">
                                     <option value="2">Tài xế</option> <option value="3">Phụ xe</option>
                                    </select>
                                  </div> 
                                  ...
                                  <div class="form-group f1">
                                    ...
                                    <input type="text" class="form-control" name="stateCode" id="stateCode" placeholder="">
                                  </div> 
