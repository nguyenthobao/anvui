 ...
 * @File /data/www/superweb/anvui/tmp/tpl/admin_laixe_home.php 
                                        ...
                                        <form id="car-search" action="" method="get">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">  
                                                    <a href="/adduser"><button type="button" class="btn btn-info">Thêm nhân viên</button></a>
                                                </div>
                                ...
                                <div class="list-car"> 
                                    <div class="list-car-body">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php if(is_array($data['laixe'])) { foreach($data['laixe'] as $k => $v) { ?>
                                                <tr>
                                                    <td><?=$v['fullName']?></td>
                                                    <td><?=$v['userName']?></td>
                                                    <td><?=$v['phoneNumber']?></td>  
                                                    ...
                                                    <td>
                                                       <a href="/edituser?id=<?=$v['userId']?>">Sửa</a>
                                                    </td>
                                                </tr>
                                                 <?php } } ?>
                                            </tbody>
