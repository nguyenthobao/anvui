 ...
 * @File /data/www/superweb/anvui/tmp/tpl/1_news.php 
 ...
 $(document).ready(function() {
            ...
            <div class="content home-box">
                <div class="container"> 
                         ...
                         <center>
                         <?php if($data['pagepre']) { ?>
                         <a href="/news?p=<?=$data['pagepre']?>"><button class="btn btn-primary btn-sm">Quay lại</button></a>
                         <?php } ?>
                         <?php if($data['pagenext']) { ?>
                         <a href="/news?p=<?=$data['pagenext']?>"><button class="btn btn-success btn-sm">Xem thêm</button></a>
                         <?php } ?>
                         </center>
                         <hr>
