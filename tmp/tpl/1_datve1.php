 ...
 * @File /data/www/superweb/anvui/tmp/tpl/1_datve1.php 
            ...
            <div class="content home-box">
                <div class="container">
                     ...
                     <div class="row listchuyen">
                     	...
                     	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 info">
                     			<p>Nhà xe</p>
                     		<h4><?=$v['companyName']?></h4>
                     		<p><?=$v['numberPlate']?></p>

                     	</div>
                     	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-4 thoigianchuyen">
                     		<div class="row">
                     			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 batdau">
                     				<h4><?=$v['startTime']?></h4>
                     				<?=$v['getInPointName']?>
                     			</div>
                     			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 quatrinh">
                     				<h4><i class="fa fa-long-arrow-right" aria-hidden="true"></i></h4>
                     				<?=$v['processTime']?>
                     			</div>
                     			<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12 kethuc">
                     				<h4><?=$v['endTime']?></h4>
                     				<?=$v['getOffPointName']?>
                     			</div>
                     		</div>
                     	</div>
                     	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4 datve">
                     		<p><b><?=$v['ticketPrice']?></b> <i>đ</i></p>

                             <?php if($v['companyStatus'] == 2) { ?>

                            <?php if(strtotime('10-2-2018') <= strtotime(date('d-m-Y')) && strtotime(date('d-m-Y')) <= strtotime('22-2-2018') ) { ?>
                           <!--<a target="_blank" href="<?=$v['web']?>dat-ve?routeId=<?=$v['routeId']?>&startPointId=<?=$v['getInPointId']?>&endPointId=<?=$v['getOffPointId']?>&date=<?=$data['date']?>&scheduleId=<?=$v['scheduleId']?>&tripIdHome=<?=$v['tripId']?>">-->
                                <button type="button" class="btn btn-danger btn-book" data-toggle="modal" data-target="#myModal"><i class="fa fa-bus" aria-hidden="true"></i> Đặt vé</button>
                            <!--</a>-->
                            <?php } else { ?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">An Vui thông báo</h4>
                </div>
                <div class="modal-body">
                    <p>Mời bạn liên hệ trực tiếp với nhà xe để đặt vé. Xin cảm ơn.</p>
                </div>
